...
class DatoReportableRequerido < ActiveRecord::Base
  ...
  attr_accessible :prestacion, :dato_reportable, :fecha_de_inicio, :fecha_de_finalizacion, :minimo, :maximo, :necesario, :obligatorio, :dato_reportable_id,:es_requerido_sirge
