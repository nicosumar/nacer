...
MetodoDeValidacion.create([
  ...
  { #:id => 2,
    ...
    :mensaje => "La prestación es para embarazadas diagnosticadas en el primer trimestre y los datos de la beneficiaria no indican la edad gestacional al diagnóstico o es posterior a las 19 semanas"
  }
])
