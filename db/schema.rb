...
ActiveRecord::Schema.define(:version => 20170508123357) do
  ...
  create_table "codigo_de_prestacion", :id => false, :force => true do |t|
    t.string "codigo"
  end
  ...
  create_table "datos_reportables", :force => true do |t|
    ...
    t.integer "dato_reportable_sirge_id"
  end
  ...
  create_table "datos_requeridos_requeridos_sirge", :id => false, :force => true do |t|
    t.integer "dato_reportable_id"
    t.integer "dato_reportable_sirge_id"
  end
  ...
  create_table "delayed_jobs", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "proceso_de_sistema_id"
  end
  ...
  create_table "estados_procesos_de_sistemas", :force => true do |t|
    t.string   "nombre"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  create_table "estados_solicitudes_addendas", :force => true do |t|
    t.string   "nombre"
    t.string   "codigo"
    t.boolean  "pendiente"
    t.boolean  "indexable"
  ...
  create_table "grupos_permitidos", :force => true do |t|
    t.integer  "grupo_poblacional_id"
  ...
  add_index "grupos_permitidos", ["grupo_pdss_id"], :name => "index_grupos_permitidos_on_grupo_pdss_id"
  add_index "grupos_permitidos", ["grupo_poblacional_id"], :name => "index_grupos_permitidos_on_grupo_poblacional_id"
  add_index "grupos_permitidos", ["sexo_id"], :name => "index_grupos_permitidos_on_sexo_id"
  ...
  create_table "historicos_prestaciones", :force => true do |t|
    t.integer  "prestacion_id"
    t.integer  "prestacion_anterior_id"
    t.datetime "created_at",             :null => false
    t.datetime "updated_at",             :null => false
  end

  add_index "historicos_prestaciones", ["prestacion_anterior_id"], :name => "index_historicos_prestaciones_on_prestacion_anterior_id"
  add_index "historicos_prestaciones", ["prestacion_id"], :name => "index_historicos_prestaciones_on_prestacion_id"
  ...
  create_table "motivos_bajas_beneficiarios", :force => true do |t|
    t.string   "nombre"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
  ...
  create_table "prestaciones", :force => true do |t|
    ...
    t.boolean  "eliminada"
    t.integer  "prestacion_principal_id"
  end
  ...
  add_index "prestaciones", ["prestacion_principal_id"], :name => "index_prestaciones_on_prestacion_principal_id"
  ...
  create_table "prestaciones_principales", :force => true do |t|
    t.string   "nombre"
    t.string   "codigo"
    t.boolean  "activa"
  ...
  create_table "procesos_de_sistemas", :force => true do |t|
    t.string   "descripcion"
    t.text     "descripcion_ultimo_error"
    t.text     "parametros_dinamicos"
    t.string   "fecha_completado"
    t.integer  "tipo_proceso_de_sistema_id"
    t.integer  "estado_proceso_de_sistema_id"
    t.integer  "user_id"
  ...
  add_index "procesos_de_sistemas", ["entidad_relacionada_id"], :name => "index_procesos_de_sistemas_on_entidad_relacionada_id"
  add_index "procesos_de_sistemas", ["estado_proceso_de_sistema_id"], :name => "index_procesos_de_sistemas_on_estado_proceso_de_sistema_id"
  add_index "procesos_de_sistemas", ["tipo_proceso_de_sistema_id"], :name => "index_procesos_de_sistemas_on_tipo_proceso_de_sistema_id"
  ...
  create_table "solicitudes_addendas", :force => true do |t|
    ...
    t.text     "observaciones"
    t.integer  "convenio_de_gestion_sumar_id"
    t.integer  "estado_solicitud_addenda_id"
    t.datetime "created_at",                   :null => false
    t.datetime "updated_at",                   :null => false
    t.date     "fecha_de_inicio"
    t.string   "numero_addenda"
    t.integer  "user_creator_id"
    t.integer  "user_tecnica_id"
    t.integer  "user_legal_id"
  end
  ...
  create_table "solicitudes_addendas_prestaciones_principales", :force => true do |t|
    t.string   "observaciones"
    t.integer  "solicitud_addenda_id"
  ...
  create_table "tipos_procesos_de_sistemas", :force => true do |t|
    t.string   "nombre"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
